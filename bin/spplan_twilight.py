...
def get_master_cal(allexps):
    ...
    drop = np.where((allexps['EXPOSURE'].data != flats['EXPOSURE'].data[0]) & (allexps['flavor'].data == 'flat'))[0]
...
def spplan2d(topdir=None, run2d=None, mjd=None, mjdstart=None, mjdend=None,
             ...
             verbose = False, returnlist=False, twilight_flats = False, **extra_kwds):
...
if __name__ == "__main__":
    ...
    run2d_grp.add_argument('--twilight_flats',   help = 'Only Use the twilight flats', action='store_true')
