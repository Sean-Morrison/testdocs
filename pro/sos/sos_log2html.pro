...
;
; PURPOSE:
;   Convert output FITS file from SOSREDUCE to HTML format.
;
; CALLING SEQUENCE:
...
;                for each frame reduced; this file is written by SOSREDUCE.
;
; OPTIONAL INPUTS:
...
function sos_log_header, title1
   ...
   ; --> No.  Disable this now.  A copy of the file is made from SOSREDUCE
...
;   textout = [textout, '<FONT SIZE="+4">']
   ...
   outaf = djs_filepath(arc_html, root_dir=outp)
   outaf = fileandpath(outaf, path= outp)
;   if file_test(djs_filepath(arc_html, root_dir=outp)) then begin
   ...
   textout = [textout, '<P>IDLSPEC2D version ' + vers2d ]
...
;                jpegfile1 = 'snplot-'+mjdstr+'-'+platestr4+'-'+expstring+'.jpeg'
;                jpegfile_15= 'snplot-sdssv15-'+mjdstr+'-'+platestr4+'-'+expstring[0]+'.jpeg'
;                printnames = '<A HREF="../'+mjdstr+'/'+ jpegfile1 + '">(S/N)^2</A>'
;                printnames_15 = '<A HREF="../'+mjdstr+'/'+  jpegfile_15 + '">15 (S/N)^2</A>'
;                textout = [ textout, $
;                            sos_log_fields(pscience[*,iexp], 'SN2', $
;                            printnames=[printnames,printnames_15], $
;                            formats=['(f7.1)','(f7.1)']) ]
;            endif else begin
;                jpegfile1 = 'snplot-'+mjdstr+'-'+platestr4+'-'+expstring[0]+'.jpeg'
;                printnames1 = '<A HREF="../'+mjdstr+'/'+  jpegfile1 + '">(S/N)^2</A>'
;                jpegfile_v2= 'snplot-sdssv-'+mjdstr+'-'+platestr4+'-'+expstring[0]+'.jpeg'
;                jpegfile_15= 'snplot-sdssv15-'+mjdstr+'-'+platestr4+'-'+expstring[0]+'.jpeg'
;                printnames_v2 = '<A HREF="../'+mjdstr+'/'+  jpegfile_v2 + '">v2 (S/N)^2</A>'
;                printnames_15 = '<A HREF="../'+mjdstr+'/'+  jpegfile_15 + '">15 (S/N)^2</A>'
;                textout = [ textout, $
;                            sos_log_fields(pscience[*,iexp], ['SN2','SN2_V2','SN2_15'], $
;                                            printnames=[printnames1,printnames_v2,printnames_15],$
;                                            formats=['(f7.1)','(f7.1)','(f7.1)']) ]
;            endelse
...
;         if not keyword_set(sdssv_sn2) then begin
;            jpegfile = 'snplot-'+mjdstr+'-'+platestr4+'.jpeg'
;            printnames = '<A HREF="../'+mjdstr+'/'+ jpegfile + '">TOTAL (S/N)^2</A>'
;
;            jpegfile_15 = 'snplot-sdssv15-'+mjdstr+'-'+platestr4+'.jpeg'
;            printnames_15 = '<A HREF="../'+mjdstr+'/'+ jpegfile_15 + '">TOTAL 15 (S/N)^2</A>'
;            textout = [ textout, $
;                        sos_log_fields(ptotal, ['TOTALSN2', 'TOTALSN2_15'],$
;                        printnames=[printnames,printnames_15], $
;                        formats=['(f7.1)','(f7.1)']) ]
;         endif else begin
;            jpegfile = 'snplot-'+mjdstr+'-'+platestr4+'.jpeg'
;            printnames = '<A HREF="../'+mjdstr+'/'+ jpegfile + '">TOTAL (S/N)^2</A>'
;            jpegfile_v2 = 'snplot-sdssv-'+mjdstr+'-'+platestr4+'.jpeg'
;            printnames_v2 = '<A HREF="../'+mjdstr+'/'+ jpegfile_v2 + '">TOTAL v2 (S/N)^2</A>'
;
;            jpegfile_15 = 'snplot-sdssv15-'+mjdstr+'-'+platestr4+'.jpeg'
;            printnames_15 = '<A HREF="../'+mjdstr+'/'+ jpegfile_15 + '">TOTAL 15 (S/N)^2</A>'
;
;            textout = [ textout, $
;                        sos_log_fields(ptotal, ['TOTALSN2','TOTALSN2_V2', 'TOTALSN2_15'],$
;                        printnames=[printnames,printnames_v2,printnames_15], $
;                        formats=['(f7.1)','(f7.1)','(f7.1)']) ]
;         endelse
      endif
