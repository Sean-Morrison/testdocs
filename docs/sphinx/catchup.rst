...
::
    ...
    slurm_pySummary --module bhm/|idlspec2d_version| --full --walltime "335:00:00"
...
::
    ...
    spplan_epoch --sdssv --mod bhm/|idlspec2d_version| --started --abandoned --logfile apo_epoch_60130.log --apo --clobber
    spplan_epoch --sdssv --mod bhm/|idlspec2d_version| --abandoned --logfile lco_epoch_60280.log --lco
    spplan_epoch --sdssv --mod bhm/|idlspec2d_version| --abandoned --logfile apo_epoch_60280.log --apo
...
::
    ...
    slurm_pySummary --module bhm/|idlspec2d_version| --full --epoch --walltime "335:00:00"
...
::
    ...
    slurm_pySummary --module bhm/|idlspec2d_version| --full --custom allepoch --walltime "335:00:00"
    slurm_pySummary --module bhm/|idlspec2d_version| --full --custom allepoch_lco --walltime "335:00:00"
